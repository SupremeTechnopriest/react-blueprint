...
var bindDimensions = function bindDimensions(ComposedComponent) {
	...
	return (function (_Component) {
		...
		function _class2() {
			...
			return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(_class2)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.state = {}, _this.updateDimensions = function () {
		...
		_createClass(_class2, [{
			...
			value: function render() {
				return _react2.default.createElement(
					...
					_react2.default.createElement(ComposedComponent, _extends({ ref: 'composedComponent' }, this.state, this.props))
				);
			}
		}]);
