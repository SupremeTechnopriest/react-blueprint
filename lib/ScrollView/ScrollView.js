...
var ScrollView = (_temp = _class = (function (_Component) {
	...
	function ScrollView(props) {
		...
		state.loaded = _this.props.delayOptimizations ? false : true;
	...
	_createClass(ScrollView, [{
		...
		value: function componentDidMount() {
			...
			if ((0, _lodash2.default)(this.computedProps.infiniteLoadBeginEdgeOffset) && this.state.infiniteComputer.getTotalScrollableHeight() < this.computedProps.containerHeight) {
				this.setState({
			...
			if (!this.state.loaded) setTimeout(function () {
		...
		value: function render() {
			...
			var displayables;
			if (_react2.default.Children.count(this.computedProps.children) > 1 && this.state.loaded) {
	...
	elementHeight: _react.PropTypes.oneOfType([_react.PropTypes.number, _react.PropTypes.arrayOf(_react.PropTypes.number)]).isRequired,
