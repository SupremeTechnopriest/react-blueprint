...
var ScrollView = (_temp = _class = (function (_Component) {
	...
	_createClass(ScrollView, [{
		...
		value: function generateComputedUtilityFunctions(props) {
			...
			if (props.useWindowAsScrollContainer) {
				utilities.subscribeToScrollListener = function () {
					window.addEventListener('scroll', _this2.infiniteHandleScroll);
				};
		...
		value: function componentDidMount() {
			...
			if ((0, _lodash.isfinite)(this.computedProps.infiniteLoadBeginEdgeOffset) && this.state.infiniteComputer.getTotalScrollableHeight() < this.computedProps.containerHeight) {
				this.setState({
		...
		value: function render() {
			...
			var displayables;
			if (_react2.default.Children.count(this.computedProps.children) > 1) {
	...
	handleScroll: _react2.default.PropTypes.func,
	...
	elementHeight: _react2.default.PropTypes.oneOfType([_react2.default.PropTypes.number, _react2.default.PropTypes.arrayOf(_react2.default.PropTypes.number)]).isRequired,
	// This is the total height of the visible window.
	containerHeight: _react2.default.PropTypes.number,
	useWindowAsScrollContainer: _react2.default.PropTypes.bool,

	displayBottomUpwards: _react2.default.PropTypes.bool.isRequired,

	infiniteLoadBeginEdgeOffset: _react2.default.PropTypes.number,
	onInfiniteLoad: _react2.default.PropTypes.func,
	loadingSpinnerDelegate: _react2.default.PropTypes.node,

	isInfiniteLoading: _react2.default.PropTypes.bool,
	timeScrollStateLastsForAfterUserScrolls: _react2.default.PropTypes.number,
